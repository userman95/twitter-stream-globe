...
### Μέρος Γ
Στο μέρος Γ της εργασίας θα πρέπει να αλλάξετε την υφή (texture) της υδρογείου, να μειώσετε την ταχύτητα περιστροφής της και να περιορίσετε της περιοχής προέλευσης των tweets από ολόκληρη την υδρόγειο σε μια ήπειρο ή σε μια χώρα.

### Μέρος Δ
Αλλάξτε την οπτικοποίηση από την 3Δ υδρόγειο σε 2Δ χάρτη και προσθέστε τη δυνατότητα αποθήκευσης δεδομένων στον server.
